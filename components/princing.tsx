export default function Princing() {
  ...
  return (
    <section id="pricing" className="bg-white text-primary">
      <div className="w-[90%] mx-auto max-w-5xl flex flex-col py-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {pricingData.map((item, index) => (
              <div key={index} className="bg-primary text-white p-6 rounded-lg shadow-md flex flex-col justify-between">
                ...
                <a href="#contact" className="bg-white text-black font-semibold py-2 px-4 mt-6 rounded-md">
                  Começar
                </a>
              </div>
            ))}
